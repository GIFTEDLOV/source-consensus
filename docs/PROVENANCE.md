...
No `resolve()` transaction was submitted. No final status/value, validator vote record, observed
configuration hash, or Explorer contract URL exists because the deployment did not finalize.
